  ...
  <div>
    ...
    <section class="flex flex-col sm:flex-row flex-wrap gap-4">
      <div
        ...
        class="bg-[#222] w-full sm:min-w-[45%] sm:flex-1 mb-5 shadow border border-[#777] p-6 rounded-lg cursor-pointer hover:opacity-90 transition"
      >
...
export default {
  ...
  async mounted() {
    ...
    this.cards = [
      ...
      { title: 'Upcoming Deadline', count: res.data.upcoming_deadline ?? '0' },
    ];
  },
  methods: {
    handleClick(title) {
